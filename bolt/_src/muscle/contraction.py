...
from bolt.consts import M_MAX_NORM_TENDON_FORCE
from bolt.consts import M_MAX_PENNATION_ANGLE
from bolt.consts import M_MIN_NORM_TENDON_FORCE
...
from bolt.types import ResidualResult
