...
def _process_swing_twist_limits(
    ...
    if swing_axis_len > BOLT_SIG_REAL:
    ...
    if wp.abs(violation_twist) > BOLT_SIG_REAL:
    ...
    if violation_swing > BOLT_SIG_REAL:
    ...
    if wp.length(tau_corrective) > BOLT_MINVAL:
