...
def attempt_adaptive_step(m: Model, d: Data):
    ...
    # k_1 = f(y_0 + (h/3) * k_0)
    integrate_common.advance(m, d, d.qacc, d.qvel, scale=1.0 / 3.0, time_scale=1.0 / 3.0, symplectic=False)
    forward.fwd(m, d)
    ...
    integrate_common.advance(m, d, d.qacc, d.qvel_buffer, scale=1.0 / 6.0, time_scale=1.0 / 3.0, symplectic=False)
    forward.fwd(m, d)
    ...
    integrate_common.advance(m, d, d.qacc, d.qvel_buffer, scale=1.0 / 8.0, time_scale=1.0 / 2.0, symplectic=False)
    forward.fwd(m, d)
    ...
    integrate_common.advance(m, d, d.qacc, d.qvel_buffer, scale=1.0 / 2.0, time_scale=1.0, symplectic=False)
    forward.fwd(m, d)
    ...
    integrate_common.advance(m, d, d.qacc, d.qvel_buffer, scale=1.0 / 6.0, time_scale=1.0, symplectic=False)
