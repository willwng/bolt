...
def restore_0(m: Model, d: Data, only_on_reject: bool):
    adaptive_common.restore_state(m, d, 0, only_on_reject=only_on_reject)
    adaptive_common.restore_state_dot(m, d, 0, only_on_reject=only_on_reject)
...
def attempt_adaptive_step(m: Model, d: Data):
    ...
    adaptive_common.compute_error(m, d, 1, scale=0.2)
