...
def safe_div(x: Any, y: Any) -> Any:
    return x / wp.where(y != 0.0, y, BOLT_MINVAL)
...
def capsule_box(
    ...
    for i in range(8):
        for j in range(3):
            ...
            if dif_sq < bestdist - BOLT_MINVAL:
                bestdist = dif_sq
                bestsegmentpos = x2
                bestboxpos = x1
